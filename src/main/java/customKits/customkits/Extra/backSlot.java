...
public class backSlot extends Effect {
    ...
    static {
        Skript.registerEffect(backSlot.class, "ckit create slot %integer% of preview to %itemstack% named %string%");
    }
    ...
    public String toString(Event event, boolean debug) {
        return "ckit create slot " + slotExpr.toString() + " of preview to " + itemExpr.toString() + " named " + nameExpr.toString();
    }
}
